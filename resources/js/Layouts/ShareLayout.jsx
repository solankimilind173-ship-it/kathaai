...
export default function ShareLayout({ children }) {
    return (
        <div className="min-h-screen bg-gradient-to-b from-amber-50/50 to-stone-100">
            <FlashToaster />
            <header className="sticky top-0 z-10 border-b border-amber-200/50 bg-white/95 px-4 py-3 shadow-sm backdrop-blur-md sm:px-6 lg:px-8">
            ...
            <main className="w-full max-w-full px-4 py-6 sm:px-6 lg:px-8 xl:px-10">
                {children}
            </main>
        </div>
    );
