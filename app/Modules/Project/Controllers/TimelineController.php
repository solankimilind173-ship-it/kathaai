...
class TimelineController extends Controller
{
    public function show(Project $project)
    {
        ...
        $savedOrder = $project->sceneRenderSettings()->orderBy('sort_order')->pluck('scene_id')->all();
        ...
        return Inertia::render('Project/Pages/Timeline', [
    ...
    public function update(Request $request, Project $project)
    {
        ...
        foreach ($sceneOrder as $index => $sceneId) {
            ...
            SceneRenderSettings::updateOrCreate(
                ['project_id' => $project->id, 'scene_id' => $sceneId],
                [
                    'sort_order' => $index,
